...
class SimpleCalculator(Tk):
    def __init__(self):
        ...
        self.btn0.grid(row=1, column=0, sticky="w")
        self.btn1.grid(row=1, column=1, sticky="w")
        self.btn2.grid(row=1, column=2, sticky="w")
        self.btn3.grid(row=1, column=3, sticky="w")
        self.btn4.grid(row=2, column=0, sticky="w")
        self.btn5.grid(row=2, column=1, sticky="w")
        self.btn6.grid(row=2, column=2, sticky="w")
        self.btn7.grid(row=2, column=3, sticky="w")
        self.btn8.grid(row=3, column=0, sticky="w")
        self.btn9.grid(row=3, column=1, sticky="w")
        self.btn_clean.grid(row=3, column=2, sticky="w")
        self.btn_equal.grid(row=3, column=3, sticky="w")
